                ...
                .andDo(
                        document("get-memories",
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("result.firstPochakedWith").type(OBJECT).description("처음 함께 포착된 순간"),
                                        ...
                                        fieldWithPath("result.firstPochakedWith.postId").type(NUMBER).description("처음 함께 포착된 순간의 게시물 아이디"),
                                        fieldWithPath("result.firstPochakedWith.postImage").type(STRING).description("처음 함께 포착된 순간의 게시물 이미지"),
                                        fieldWithPath("result.firstPochakedWith.postDate").type(STRING).description("처음 함께 포착된 순간의 게시물 날짜"),
